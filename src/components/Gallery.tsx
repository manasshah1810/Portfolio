...
const ALBUM_DATA: Record<string, MediaItem[]> = {
    internships: [
        ...
        { id: "i2b", url: "/internships/Hophead Completion Letter_page-0001 (1).jpg", type: "image", date: "June 2024", location: "Remote", album: "internships", title: "HopHead Completion Letter", description: "Official letter of completion from HopHead confirming successful delivery of mobile feature modules and API integration tasks.", size: "418 KB", dimensions: "2480 x 3508" },
        ...
        { id: "i6", url: "/internships/Screenshot 2026-03-13 185356.png", type: "image", date: "Feb 2026", location: "Mumbai, India", album: "internships", title: "Cogniify Letter of Appointment", description: "Appointed as Lead Business Development Officer at Cogniify AI India Private Limited. 2-month internship starting February 23, 2026, focused on AI-driven business strategy and product growth.", size: "320 KB", dimensions: "1200 x 1600" },
    ],
    courses: [
        ...
        { id: "c5", url: "/courses/Google Developer Student Club Python and AI Bootcamp_page-0001.jpg", type: "image", date: "2023", location: "Online", album: "courses", title: "Google DSC Python & AI Bootcamp", description: "Successfully completed a 7-day Python and Artificial Intelligence bootcamp in partnership with Google Developer Student Clubs and DevTown.", size: "850 KB", dimensions: "2480 x 1754" },
        { id: "c6", url: "/courses/Nakshatra.jpg", type: "image", date: "Mar 2024", location: "Mumbai", album: "courses", title: "Nakshatra – Cultural Certificate", description: "Certificate of Appreciation from SVKM's Shri Bhagubhai Mafatlal Polytechnic for participation in 'Nakshatra – Where Stars Unite', the annual social gathering event organized by the Cultural Committee.", size: "400 KB", dimensions: "1600 x 2100" },
        { id: "c7", url: "/hackerrank/1719979617421-certificate (1) (1).png", type: "image", date: "Jul 2024", location: "Online", album: "courses", title: "Youth Leadership for Climate Action", description: "Certificate by CEE, LiFE, UNICEF Maharashtra, and Government of Maharashtra for completing the online course 'Youth Leadership for Climate Action: Waste Management and Climate Action'. Issued July 3, 2024.", size: "600 KB", dimensions: "2480 x 1754" },
    ],
    hackathons: [
        ...
        { id: "h4", url: "/hackathons/Manas Shah (3)_page-0001.jpg", type: "image", date: "Feb 2025", location: "Mumbai", album: "hackathons", title: "VES Technothon 2025", description: "Certificate of Participation for submitting an innovative idea at VES Technothon 2025 — a 24-hour state-level hackathon for Diploma Engineers organized by VES Polytechnic, Chembur in collaboration with VESP Alumni Association.", size: "950 KB", dimensions: "2970 x 2100" },
        { id: "h5", url: "/hackathons/Screenshot 2026-03-13 190138.png", type: "image", date: "Feb 2024", location: "Mumbai", album: "hackathons", title: "Code Carnival 5.0 – Ignite IT", description: "Certificate of Participation for Code Carnival 5.0, an event at the 'Ignite IT' fest held at SVKM's Shri Bhagubhai Mafatlal Polytechnic on 3rd February 2024, organized by the Information Technology Department.", size: "1.2 MB", dimensions: "2970 x 2100" },
    ],
    hackerrank: [
